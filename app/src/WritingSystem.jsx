...
const S = {
  ...
  center: { flex:1, overflowY:"auto", padding:"20px 24px", display:"flex", flexDirection:"column", gap: tokens.space.xxl, maxWidth:1100 },
  ...
  help: { width:260, background:"transparent", display:"flex", flexDirection:"column", overflowY:"auto", flexShrink:0 },
